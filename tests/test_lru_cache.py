...
def test_case_i():
    ...
    assert lru_cache_object.key_value_map_cache == {1: 1}
    lru_cache_object.put(2, 2)
    assert lru_cache_object.key_value_map_cache == {1: 1, 2: 2}
    assert lru_cache_object.get(1) == 1
    lru_cache_object.put(3, 3)
    assert lru_cache_object.key_value_map_cache == {1: 1, 3: 3}
    assert lru_cache_object.get(2) == -1
    lru_cache_object.put(4, 4)
    assert lru_cache_object.key_value_map_cache == {4: 4, 3: 3}
    assert lru_cache_object.get(1) == -1
